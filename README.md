...
Тап по карточке открывает экран **«Техника»**: напряжение и ток тяговой батареи, доступная мощность батареи, лимиты BMS на заряд и разряд, разброс ячеек, температуры моторов и инверторов, доля мощности перед/зад в процентах, климат, давление и температура шин, история SoH и пробега. У каждого параметра есть значок «?» с подсказкой простым языком. Если машина не отдаёт параметр, строка показывает «-», пустые карточки скрываются.
