...
| **Voice** | Голосовой агент | Русский офлайн-ассистент: распознавание речи на устройстве, AI-агент (29 инструментов), нейросетевая озвучка |
...
У агента 29 инструментов. Примеры фраз:

**Машина и климат**
- «Сколько заряда?», «Какая температура за бортом?», «Какой запас хода?» (живое состояние машины)
- «Открой окна», «Включи подогрев сиденья», «Поставь климат на 22» (полный каталог из 79 команд, см. ниже)
...
### Управление машиной: каталог из 79 команд
...
Это автоматический расчёт. Если он вам не подходит, в **Настройки → Батарея → «Способ расчёта запаса хода»** есть метод «Ручной»: своя таблица из 5 точек, температура батареи от +20 до -20 °C и расход при ней, опционально с запасом хода на 100% заряда.
